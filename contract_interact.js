...
const contractAddress = "0x09A686627d817dFc318F2EeB9ec792920dA207b1";
...
async function sendTransactions()
{
    ...
    await voter.method.addOption("coffee").send({from: fromAddress})

    console.log("Adding option 'tea'");
    await voter.method.addOption("tea").send({from: fromAddress});
